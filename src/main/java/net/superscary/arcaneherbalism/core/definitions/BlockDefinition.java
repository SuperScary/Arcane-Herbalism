package net.superscary.arcaneherbalism.core.definitions;
...
public class BlockDefinition<T extends Block> implements ItemLike {
    ...
    public BlockDefinition(String englishName, DeferredBlock<T> block, @Nullable ItemDefinition<BlockItem> item) {
    ...
    public DeferredBlock<T> getDeferredBlock () {
        return block;
    }
